...
#define ENDIS_MOTORS_PIN   26 //ESP32 GPIO pin number for ENable/DISabling motors 0:enable,1:disable
#define X0_SENSOR_PIN      35 //Print head home detect limit switch status read pin on x axis (X0)(Normally open)
#define Y0LEFT_SENSOR_PIN  34 //Print head home detect limit switch status read pin y-axis left side (Normally open)
#define Y0RIGHT_SENSOR_PIN 39 //Print head home detect limit switch status read pin y-axis right side (Normally open)
#define XMAX_SENSOR_PIN    36
#define SERVO_CONTROL_PIN  25

#define MARKER_OFF_ANG      0 //Lift up
#define MARKER_ON_ANG       90 //Push down
#define MARKER_UPDOWN_DELAY 300//mlilli sec
#define POS_X_MAX 305//1.0' //640 //mm (=64cm)
...
#define SPMM  80.0//81.5 //Steps Per MilliMeter
