...
#define CFG_MOTORS_MAXSPEED 12000
...
#define ENDIS_MOTORS_PIN 8 //Pin number on Arduino nano for ENable/DISabling motors 0:enable,1:disable
#define X_MOTOR_DIR_PIN 5
#define Y_MOTOR_DIR_PIN 6
#define X_MOTOR_PULSE_PIN 2
#define Y_MOTOR_PULSE_PIN 3
...
#define CFG_XMOTOR_SPEED CFG_MOTORS_MAXSPEED
#define CFG_YMOTOR_SPEED CFG_MOTORS_MAXSPEED
#define MOTORS_STEP_DELAY_MICROS 30
 
#define X_MOTOR_MAX_STEPS POS_X_MAX*SPMM //set to detect home position
#define Y_MOTOR_MAX_STEPS POS_Y_MAX*SPMM //set to detect home position
...
bool x_motor_dir = false;
bool y_motor_dir = false;
uint32_t x_motor_step_delay = MOTORS_STEP_DELAY_MICROS;
uint32_t y_motor_step_delay = MOTORS_STEP_DELAY_MICROS;
int32_t x_motor_speed = CFG_XMOTOR_SPEED;
int32_t y_motor_speed = CFG_YMOTOR_SPEED;
bool ack_nack_sent   = false;
bool cmd_pending = false;
